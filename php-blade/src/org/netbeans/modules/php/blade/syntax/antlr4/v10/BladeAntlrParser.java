...
public class BladeAntlrParser extends Parser {
	...
	public static final int
		...
		RULE_echo = 34, RULE_echo_ne = 35, RULE_php_expression = 36, RULE_singleArgWrapper = 37, 
		RULE_singleArgAndDefaultWrapper = 38, RULE_doubleArgWrapper = 39, RULE_multiArgWrapper = 40, 
		RULE_identifiableArgument = 41, RULE_composedArgument = 42, RULE_paramAssign = 43, 
		RULE_verbatim_block = 44, RULE_loop_action = 45, RULE_html = 46;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"echo_ne", "php_expression", "singleArgWrapper", "singleArgAndDefaultWrapper", 
			"doubleArgWrapper", "multiArgWrapper", "identifiableArgument", "composedArgument", 
			"paramAssign", "verbatim_block", "loop_action", "html"
		};
	}
	...
	public final SingleArgWrapperContext singleArgWrapper() throws RecognitionException {
		...
		enterRule(_localctx, 74, RULE_singleArgWrapper);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(414);
	...
	public final SingleArgAndDefaultWrapperContext singleArgAndDefaultWrapper() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_singleArgAndDefaultWrapper);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final DoubleArgWrapperContext doubleArgWrapper() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_doubleArgWrapper);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(432);
	...
	public final MultiArgWrapperContext multiArgWrapper() throws RecognitionException {
		...
		enterRule(_localctx, 80, RULE_multiArgWrapper);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final IdentifiableArgumentContext identifiableArgument() throws RecognitionException {
		...
		enterRule(_localctx, 82, RULE_identifiableArgument);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ComposedArgumentContext composedArgument() throws RecognitionException {
		...
		enterRule(_localctx, 84, RULE_composedArgument);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final ParamAssignContext paramAssign() throws RecognitionException {
		...
		enterRule(_localctx, 86, RULE_paramAssign);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Verbatim_blockContext verbatim_block() throws RecognitionException {
		...
		enterRule(_localctx, 88, RULE_verbatim_block);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Loop_actionContext loop_action() throws RecognitionException {
		...
		enterRule(_localctx, 90, RULE_loop_action);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final HtmlContext html() throws RecognitionException {
		...
		enterRule(_localctx, 92, RULE_html);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
