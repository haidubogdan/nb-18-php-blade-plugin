...
public class BladeAntlrParser extends Parser {
	...
	public static final int
		...
		RULE_yield = 19, RULE_stack = 20, RULE_include = 21, RULE_each = 22, RULE_hasSection = 23, 
		RULE_custom_directive = 24, RULE_php_blade = 25, RULE_echo = 26, RULE_echo_ne = 27, 
		RULE_php_expression = 28, RULE_singleArgWrapper = 29, RULE_singleArgAndDefaultWrapper = 30, 
		RULE_multiArgWrapper = 31, RULE_identifiableArgument = 32, RULE_composedArgument = 33, 
		RULE_verbatim_block = 34, RULE_loop_action = 35, RULE_html = 36;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"forelse", "yield", "stack", "include", "each", "hasSection", "custom_directive", 
			"php_blade", "echo", "echo_ne", "php_expression", "singleArgWrapper", 
			"singleArgAndDefaultWrapper", "multiArgWrapper", "identifiableArgument", 
			"composedArgument", "verbatim_block", "loop_action", "html"
		};
	}
	...
	public final FileContext file() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 117434564902514688L) != 0) || ((((_la - 69)) & ~0x3f) == 0 && ((1L << (_la - 69)) & 191517L) != 0)) {
				{
				{
				setState(74);
				general_statement();
	...
	public final EachContext each() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_each);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final HasSectionContext hasSection() throws RecognitionException {
		...
		enterRule(_localctx, 46, RULE_hasSection);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Custom_directiveContext custom_directive() throws RecognitionException {
		...
		enterRule(_localctx, 48, RULE_custom_directive);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(310);
	...
	public final Php_bladeContext php_blade() throws RecognitionException {
		...
		enterRule(_localctx, 50, RULE_php_blade);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(313);
	...
	public final EchoContext echo() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_echo);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(317);
	...
	public final Echo_neContext echo_ne() throws RecognitionException {
		...
		enterRule(_localctx, 54, RULE_echo_ne);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(321);
	...
	public final Php_expressionContext php_expression() throws RecognitionException {
		...
		enterRule(_localctx, 56, RULE_php_expression);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final SingleArgWrapperContext singleArgWrapper() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_singleArgWrapper);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(330);
	...
	public final SingleArgAndDefaultWrapperContext singleArgAndDefaultWrapper() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_singleArgAndDefaultWrapper);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final MultiArgWrapperContext multiArgWrapper() throws RecognitionException {
		...
		enterRule(_localctx, 62, RULE_multiArgWrapper);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final IdentifiableArgumentContext identifiableArgument() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_identifiableArgument);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final ComposedArgumentContext composedArgument() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_composedArgument);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final Verbatim_blockContext verbatim_block() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_verbatim_block);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final HtmlContext html() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_html);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
